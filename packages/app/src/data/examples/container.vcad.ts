...
const document: Document = {
  ...
  nodes: {
    ...
    "8": { id: 8, name: "Handle Bar Rotate (Z=90°)", op: { type: "Rotate", child: 7, angles: { x: 0, y: 0, z: 90 } } },
    ...
    "12": { id: 12, name: "Left Support Rotate (X=90°)", op: { type: "Rotate", child: 11, angles: { x: 90, y: 0, z: 0 } } },
    ...
    "16": { id: 16, name: "Right Support Rotate (X=90°)", op: { type: "Rotate", child: 15, angles: { x: 90, y: 0, z: 0 } } },
    ...
    "22": { id: 22, name: "Rim Rotate (X=90°)", op: { type: "Rotate", child: 21, angles: { x: 90, y: 0, z: 0 } } },
